...
<tr>
	<th>Product ID</th>
	<td><input type="text" class="form-control" name="id" value="<%= id%>" ><br></td>
</tr>
<tr>
	<th>Product Name</th>
	<td><input type="text" class="form-control" name="pname" value="<%= name%>"><br></td>
</tr>
<tr>
	<th>Product Description</th>
	<td><input type="text" class="form-control" name="pdescription" value="<%= description%>"><br></td>
</tr>
<tr>
	<th>Product Price</th>
	<td><input type="text" class="form-control" name="pprice" value="<%= price%>"><br> </td>
</tr>
<tr>
	<th>Seller Id</th>
	<td><input type="text" class="form-control" name="psellerid" value="<%= sellerid%>"><br> </td>
</tr>
<tr>
	<th>Bidder Id</th>
	<td><input type="text" class="form-control" name="pbidderid" value="<%= bidderid%>"><br></td>
</tr>
</table>
