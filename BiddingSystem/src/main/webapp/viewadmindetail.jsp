...
<tr>
	...
	<th>Admin name</th>
	<td><input type="text" name="aname" value="<%= aname%>"><br></td>
</tr>
<tr>

	<th>Admin Telephone</th>
	<td><input type="text" name="atelephone" pattern="[0-9]{10}" value="<%= atelephone%>"><br></td>
</tr>
<tr>

	<th>Admin NIC</th>
	<td><input type="text" name="aNIC" pattern="[0-9]{12}" value="<%= aNIC%>"><br></td>
</tr>
<tr>

	<th>Admin username</th>
	<td><input type="email" name="ausername" pattern=".+@skybid\.lk" value="<%= ausername%>"><br></td>
</tr>
<tr>

	<th>Admin password</th>
	<td><input type="text" name="apassword" pattern=".{8,}" value="<%= apassword%>"><br></td>
</tr>
<tr>
...
<table class="table table-bordered table-striped text-center">
	<tr>
		<th>Admin NIC</th>
		<td><input type="text" name="aNIC" value="<%= aNIC%>" ><br></td>
	</tr>	
	<tr>
