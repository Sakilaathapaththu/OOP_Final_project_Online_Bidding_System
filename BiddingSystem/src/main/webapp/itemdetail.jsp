...
<c:forEach var="cus" items="${itemdetail}">
	 	...
	 	<c:set var="pname" value="${cus.pname}"/>
	 	<c:set var="pdescription" value="${cus.pdescription}"/>
	 	<c:set var="pprice" value="${cus.pprice}"/>
	 	<c:set var="psellerid" value="${cus.psellerid}"/>
	 	<c:set var="pbidderid" value="${cus.pbidderid}"/>
...
<a href="${admupdate}">
<input type="button" name="updateitem" value="update product" class="btn btn-success">
</a>
...
<a href="${admdelete}">
<input type="button" name="deleteitem" value="Delete product" class="btn btn-success">
</a>
