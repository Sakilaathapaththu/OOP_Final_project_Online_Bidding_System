...
<div>
<p>The customer bids on the products placed by the seller and the product is sold to the highest bidder.</p>
</div>

<div>
<p>A bid can be placed for a given maximum amount and the seller can get maximum profit from the bidding products. </p>
</div>
